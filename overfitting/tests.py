...
class TestDecisionTree(unittest.TestCase):
        ...
        def test_divide_treino_teste(self):
            ...
            for i in range(1,9):
                ...
                self.assertEquals(len(df_treino),i,"O teste não está com a quantidade correta de elementos")
                self.assertEquals(len(df_teste),10-i,"O teste não está com a quantidade correta de elementos")
